              ...
              <div className="row">
                <div className="col-md-7  p-5">
                  ...
                  <h6 className=" text-white text-xl font-light">
                    Nous sommes une société marocaine, d’où nous inspirons notre
                    authenticité et notre culture de qualité d’accueil et de
                    convivialité. Notre devise est notre image de marque, c’est
                    la raison pour laquelle nous nous battons tout le temps pour
                    l’améliorer davantage. Restons à la hauteur c’est notre
                    souci permanant. IZT, est votre partenaire de confiance.
                  </h6>
                </div>
